...
<br><br><br>
<button class="btn btn-block btn-secondary waves-effect waves-light" style="cursor: auto;">Google Search</button>
...
<button class="btn btn-secondary mr-sm-2" type="submit" name="sa" value="Search">Search</button>
